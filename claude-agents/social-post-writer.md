...
description: |-
  ...
  Use when: Use this agent when you need to write social media captions and require production-ready output. e.g. write social media captions; create posts for content calendar; social copy for [platform]
