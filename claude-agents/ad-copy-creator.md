...
description: |-
  ...
  Use when: Use this agent when you need to write ad copy and require production-ready output. e.g. write ad copy; ad variants for campaign; headlines and descriptions for Google/Meta/TikTok/LinkedIn
