...
description: |-
  ...
  Use when: Use this agent when you need to plan social media calendar and require high-level strategic planning. e.g. plan social media calendar; choose which platforms to focus on; build content pillars
