...
description: |-
  ...
  Use when: Use this agent when you need to build an email sequence and require production-ready output. e.g. build an email sequence; welcome email flow; nurture drip sequence
