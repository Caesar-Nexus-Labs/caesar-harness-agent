...
when_to_use: >-
  Use this agent when you need to plan content for SEO and require high-level strategic planning.
examples:
  - context: "User needs to plan content for SEO"
    trigger: "plan content for SEO"
  - context: "User needs to identify keyword gaps"
    trigger: "identify keyword gaps"
  - context: "User needs to build content calendar"
    trigger: "build content calendar"
---
