...
description: |-
  ...
  Use when: Use this agent when you need to write a cold outreach email and require production-ready output. e.g. write a cold outreach email; backlink outreach sequence; guest post pitch email; write a LinkedIn outreach message
