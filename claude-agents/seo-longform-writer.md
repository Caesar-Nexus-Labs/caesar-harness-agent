...
description: |-
  ...
  Use when: Use this agent when you need to write a blog article and require production-ready output. e.g. write a blog article; long-form SEO content; blog post for keyword
