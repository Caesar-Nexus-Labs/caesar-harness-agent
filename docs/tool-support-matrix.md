...
| **Claude Plugin Marketplace**| `.claude-plugin/marketplace.json`, `.claude-plugin/plugin.json`, `claude-agents/*.md` | Native Aggregate | Plugin registry index, configuration, and isolated agent files |
