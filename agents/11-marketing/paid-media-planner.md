...
when_to_use: >-
  Use this agent when you need to plan our paid media strategy and require high-level strategic planning.
examples:
  - context: "User needs to plan our paid media strategy"
    trigger: "plan our paid media strategy"
  - context: "User needs to set ROAS and CPA targets"
    trigger: "set ROAS and CPA targets"
  - context: "User needs to design paid funnel structure"
    trigger: "design paid funnel structure"
---
