...
when_to_use: >-
  Use this agent when you need to find where our funnel is leaking and require high-level strategic planning.
examples:
  - context: "User needs to find where our funnel is leaking"
    trigger: "find where our funnel is leaking"
  - context: "User needs to prioritize A/B tests"
    trigger: "prioritize A/B tests"
  - context: "User needs to analyze conversion data"
    trigger: "analyze conversion data"
---
